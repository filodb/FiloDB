...
class FilodbCliSpec extends RunnableSpec {
  "A Filodb Cli" must {
    ...
    "test hex to binary conversion, decode partkey and chunkInfo" in {
      CliMain.partKeyBrAsString("0x9d0100009808120000002e0000008a2a8c351a006e6f64655f66696c6573797374656d5f73697a655f62797465737101c10a0075732d776" +
      ...
      CliMain.decodeChunkInfo("0xd9dd2a5d62b595dd14000000445ae65676010000ce53f85676010000")
    }
