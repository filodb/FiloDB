...
object CliMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    if(conf.get("spark.master","") == "")
      conf.set("spark.master","local[4]")
    if(conf.get("spark.filodb.cassandra.hosts","") == "")
      conf.set("spark.filodb.cassandra.hosts","localhost")
    if(conf.get("spark.filodb.cassandra.port","") == "")
      conf.set("spark.filodb.cassandra.port","9042")
    if(conf.get("spark.filodb.cassandra.keyspace","") == "")
      conf.set("spark.filodb.cassandra.keyspace","cli")
