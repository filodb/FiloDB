...
object Messages {
  ...
  case object InconsistentState extends ErrorResponse

  // for conditional updates - race condition detected!
  case object TooManyRequests extends ErrorResponse

  // Need to retry later when limit dies down
