...
class SegmentRowIndexSpec extends FunSpec with Matchers {
  describe("UpdatableSegmentRowIndex") {
    ...
    it("should be able to merge two indices together") {
      ...
      val rowIndex2 = new UpdatableSegmentRowIndex[Long]
    ...
    it("should be able to serialize to Filo vectors") {
      ...
      val readIndex = new BinarySegmentRowIndex(chunkIdBuf, rowNumBuf)
