...
final case class RemoteErrorResponse(status: String, errorType: String, error: String,
                                     queryStats: Option[Seq[RemoteQueryStats]] = None) extends PromQueryResponse
...
final case class RemoteQueryStats(group: Seq[String], timeSeriesScanned: Long,
