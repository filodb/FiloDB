  ...
  def sketchFold(acc: ItemsSketch[ZeroCopyUTF8String], rv: RangeVector):
    ...
    rv.rows().foreach{ r =>
      ...
      mapcast.foreach { pair =>
        // 99% sure this String cast is needed to cover up a Scala/Java interface bug.
        // The tuple should contain two ZeroCopyUTF8Strings, but the second string is
        //    generated by Java code and and recognized as a Java String at runtime.
