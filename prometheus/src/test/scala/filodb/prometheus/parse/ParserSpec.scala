...
//    parseError("rate(foo[1h5m25s]) @end()")
  ...
  it("parse subquery using antl"){
    parseWithAntlr(
      ...
      "ApplyLimitFunction(SubqueryWithWindowing(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524854160000,1524855900000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524854160000,60000,1524855900000,300000,Rate,false,List(),None,None,List(ColumnFilter(__name__,Equals(http_requests_total)))),1524855988000,0,1524855988000,MinOverTime,List(),1800000,60000,Some(60000),None),List(),RangeParams(1524855988,1000,1524855988),10)"
    )
    parseWithAntlr(
  ...
  it("Should be able to make logical plans for Series Expressions") {
    val queryToLpString = Map(
      ...
      "irate(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Irate,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "idelta(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Idelta,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "resets(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Resets,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "deriv(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Deriv,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "rate(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Rate,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "last(jvm_memory{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(jvm_memory))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Last,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(jvm_memory))))",
      ...
      "increase(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Increase,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      ...
      "changes(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Changes,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "quantile_over_time(0.4,http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,QuantileOverTime,false,List(ScalarFixedDoublePlan(0.4,RangeParams(1524855988,1000,1524855988))),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      ...
      "holt_winters(http_requests_total{job=\"api-server\"}[5m], 0.01, 0.1)" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,HoltWinters,false,List(ScalarFixedDoublePlan(0.01,RangeParams(1524855988,1000,1524855988)), ScalarFixedDoublePlan(0.1,RangeParams(1524855988,1000,1524855988))),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "z_score(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,ZScore,false,List(),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
      "predict_linear(http_requests_total{job=\"api-server\"}[5m], 10)" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,PredictLinear,false,List(ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988))),None,None,List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))))",
     ...
     // Logical plan generated when expression does not have brackets according to precedence is same as logical plan for expression with brackets which are according to precedence
      ...
      "timestamp(http_requests_total)" -> "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,0,Timestamp,false,List(),None,None,List())",
