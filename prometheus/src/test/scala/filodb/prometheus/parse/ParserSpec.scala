...
//    parseError("rate(foo[1h5m25s]) @end()")
  ...
  it("parse subquery using antl"){
    parseWithAntlr(
      ...
      "ApplyLimitFunction(SubqueryWithWindowing(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524854160000,1524855900000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524854160000,60000,1524855900000,300000,Rate,false,List(),None,None),1524855988000,0,1524855988000,MinOverTime,List(),1800000,60000,Some(60000),None),List(),RangeParams(1524855988,1000,1524855988),10)"
    )
    parseWithAntlr(
      "(heap_usage + heap_usage)[5m:1m]",
      "TopLevelSubquery(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,None,None),None,List(),List()),1524855720000,60000,1524855960000,300000,None,None)"
    )
    parseWithAntlr(
      "heap_usage[10m:1m] offset 30s",
      "TopLevelSubquery(PeriodicSeries(RawSeries(IntervalSelector(1524855360000,1524855900000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855360000,60000,1524855900000,None,None),1524855360000,60000,1524855900000,600000,Some(30000),None)"
    )

    parseWithAntlr(
      "sum_over_time(heap_usage[10m:1m] offset 3m)[2m:1m] offset 1m",
      "TopLevelSubquery(SubqueryWithWindowing(PeriodicSeries(RawSeries(IntervalSelector(1524855060000,1524855720000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855060000,60000,1524855720000,None,None),1524855840000,60000,1524855900000,SumOverTime,List(),600000,60000,Some(180000),None),1524855840000,60000,1524855900000,120000,Some(60000),None)"
    )
    parseWithAntlr(
      "sum_over_time(heap_usage[3m:1m] offset 3m)",
      "SubqueryWithWindowing(PeriodicSeries(RawSeries(IntervalSelector(1524855660000,1524855780000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855660000,60000,1524855780000,None,None),1524855988000,0,1524855988000,SumOverTime,List(),180000,60000,Some(180000),None)"
    )
    parseWithAntlr(
      "sum_over_time(sum_over_time(heap_usage[3m:1m] offset 3m)[2m:1m] offset 1m)",
      "SubqueryWithWindowing(SubqueryWithWindowing(PeriodicSeries(RawSeries(IntervalSelector(1524855480000,1524855720000),List(ColumnFilter(__name__,Equals(heap_usage))),List(),Some(300000),None,false),1524855480000,60000,1524855720000,None,None),1524855840000,60000,1524855900000,SumOverTime,List(),180000,60000,Some(180000),None),1524855988000,0,1524855988000,SumOverTime,List(),120000,60000,Some(60000),None)"
    )
  }
  ...
  it("parse expressions with unary operators") {
    ...
    parseWithAntlr("-foo", """ScalarVectorBinaryOperation(SUB,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)""")
    parseWithAntlr("foo * -1", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false)""".stripMargin)
    parseWithAntlr("-1 * foo", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)""".stripMargin)
    parseWithAntlr("-1 * -foo", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(SUB,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),true)""".stripMargin)
    parseWithAntlr("sum(foo) < -1", """ScalarVectorBinaryOperation(LSS,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),false)""")
    parseWithAntlr("-sum(foo) < -1", """ScalarVectorBinaryOperation(LSS,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(SUB,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),true),false)""")
    parseWithAntlr("sum(-foo) < -1", """ScalarVectorBinaryOperation(LSS,ScalarBinaryOperation(SUB,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,ScalarVectorBinaryOperation(SUB,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),List(),None),false)""")
    ...
    parseWithAntlr("+foo", """ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)""")
    parseWithAntlr("foo * +1", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(ADD,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false)""")
    parseWithAntlr("+1 * foo", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(ADD,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)""")
    parseWithAntlr("+1 * +foo", """ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(ADD,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),true)""")
    parseWithAntlr("sum(foo) < +1", """ScalarVectorBinaryOperation(LSS,ScalarBinaryOperation(ADD,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),false)""")
    parseWithAntlr("+sum(foo) < +1", """ScalarVectorBinaryOperation(LSS,ScalarBinaryOperation(ADD,Left(0.0),Left(1.0),RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),true),false)""")
  ...
  it("Should be able to make logical plans for Series Expressions") {
    val queryToLpString = Map(
      "http_requests_total + time()" -> "ScalarVectorBinaryOperation(ADD,ScalarTimeBasedPlan(Time,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false)",
      ...
      "scalar(http_requests_total)" -> "ScalarVaryingDoublePlan(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000),Scalar,List())",
      "scalar(http_requests_total) + node_info" ->
        "ScalarVectorBinaryOperation(ADD,ScalarVaryingDoublePlan(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Scalar,List()),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(node_info))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)",
      "10 + http_requests_total" -> "ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true)",
      "vector(3)" -> "VectorPlan(ScalarFixedDoublePlan(3.0,RangeParams(1524855988,1000,1524855988)))",
      "vector(scalar(http_requests_total))" -> "VectorPlan(ScalarVaryingDoublePlan(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Scalar,List()))",
      "scalar(http_requests_total)" -> "ScalarVaryingDoublePlan(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Scalar,List())",
      "10 + http_requests_total * 5" ->
        "ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(MUL,ScalarFixedDoublePlan(5.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false),true)",
      "10 + (http_requests_total * 5)" ->
        "ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(MUL,ScalarFixedDoublePlan(5.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false),true)",
      "(10 + http_requests_total) * 5" ->
        "ScalarVectorBinaryOperation(MUL,ScalarFixedDoublePlan(5.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),false)",
      "topk(5, http_requests_total)" ->
        "Aggregate(TopK,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(5.0),None)",
      "topk(5, http_requests_total::foo)" ->
        "Aggregate(TopK,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(foo),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(5.0),None)",
      ...
      "histogram_avg(rate(http_requests_total[5m]))" ->
        "Aggregate(HistogramAvg,PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Rate,false,List(),None,None),List(),None)",
      ...
      "group(http_requests_total)" ->
        "Aggregate(Group,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None)",
      "irate(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Irate,false,List(),None,None)",
      "idelta(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Idelta,false,List(),None,None)",
      "resets(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Resets,false,List(),None,None)",
      "deriv(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Deriv,false,List(),None,None)",
      "rate(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Rate,false,List(),None,None)",
      "last(jvm_memory{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(jvm_memory))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Last,false,List(),None,None)",
      "http_requests_total{job=\"prometheus\"}[5m]" ->
        "RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false)",
      "http_requests_total::sum{job=\"prometheus\"}[5m]" ->
        "RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(http_requests_total))),List(sum),Some(300000),None,false)",
      "http_requests_total::foo::sum{job=\"prometheus\"}[5m]" ->
        "RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(http_requests_total::foo))),List(sum),Some(300000),None,false)",
      "http_requests_total offset 5m" ->
        "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),Some(300000),false),1524855988000,1000000,1524855988000,Some(300000),None)",
      "http_requests_total offset 0.5m" ->
        "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),Some(30000),false),1524855988000,1000000,1524855988000,Some(30000),None)",
      "http_requests_total{environment=~\"staging|testing|development\",method!=\"GET\"}" ->
        "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(environment,EqualsRegex(staging|testing|development)), ColumnFilter(method,NotEquals(GET)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None)",

      "http_req_latency{job=\"api-server\",_bucket_=\"2.5\"}" ->
        "ApplyInstantFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_req_latency))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),HistogramBucket,List(ScalarFixedDoublePlan(2.5,RangeParams(0,9223372036854775807,60000))))",
      "rate(http_req_latency{job=\"api-server\",_bucket_=\"2.5\"}[5m])" ->
        "PeriodicSeriesWithWindowing(ApplyInstantFunctionRaw(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_req_latency))),List(),Some(300000),None,false),HistogramBucket,List(ScalarFixedDoublePlan(2.5,RangeParams(0,9223372036854775807,60000)))),1524855988000,1000000,1524855988000,300000,Rate,false,List(),None,None)",

      "method_code:http_errors:rate5m / ignoring(code) group_left method:http_requests:rate5m" ->
        "BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method_code:http_errors:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,ManyToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method:http_requests:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(code),List())",
      "method_code:http_errors:rate5m / ignoring(code) group_left(mode, instance) method:http_requests:rate5m" ->
        "BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method_code:http_errors:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,ManyToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method:http_requests:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(code),List(mode, instance))",
      "method_code:http_errors:rate5m / ignoring(code) group_right method:http_requests:rate5m" ->
        """BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method_code:http_errors:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,OneToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method:http_requests:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(code),List())""",
      "method_code:http_errors:rate5m / on() group_left method:http_requests:rate5m" ->
        "BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method_code:http_errors:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,ManyToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(method:http_requests:rate5m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Some(List()),List(),List())",

      "increase(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Increase,false,List(),None,None)",
      ...
      "sum({__name__=\"foo\",job=\"myjob\"})" ->
        "Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo)), ColumnFilter(job,Equals(myjob))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None)",
      "sum(http_requests_total)       \n \n / \n\n    sum(http_requests_total)" ->
        """BinaryJoin(Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),DIV,OneToOne,Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),None,List(),List())""",

      "changes(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,Changes,false,List(),None,None)",
      "quantile_over_time(0.4,http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,QuantileOverTime,false,List(ScalarFixedDoublePlan(0.4,RangeParams(1524855988,1000,1524855988))),None,None)",
      "label_replace(http_requests_total,instance,new-label,instance,\"(.*)-(.*)\")" -> "ApplyMiscellaneousFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),LabelReplace,List(instance, new-label, instance, (.*)-(.*)))",
      "hist_to_prom_vectors(http_request_latency)" ->
        "ApplyMiscellaneousFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_request_latency))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),HistToPromVectors,List())",
      "holt_winters(http_requests_total{job=\"api-server\"}[5m], 0.01, 0.1)" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,HoltWinters,false,List(ScalarFixedDoublePlan(0.01,RangeParams(1524855988,1000,1524855988)), ScalarFixedDoublePlan(0.1,RangeParams(1524855988,1000,1524855988))),None,None)",
      "z_score(http_requests_total{job=\"api-server\"}[5m])" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,ZScore,false,List(),None,None)",
      "predict_linear(http_requests_total{job=\"api-server\"}[5m], 10)" ->
        "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,300000,PredictLinear,false,List(ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988))),None,None)",
     ...
     // Logical plan generated when expression does not have brackets according to precedence is same as logical plan for expression with brackets which are according to precedence
      "(10 % http_requests_total) + 5" ->
        "ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(5.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(MOD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),false)",
      "10 % http_requests_total + 5" ->
        "ScalarVectorBinaryOperation(ADD,ScalarFixedDoublePlan(5.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(MOD,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),true),false)",

      "(http_requests_total % http_requests_total) + http_requests_total" ->
        "BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MOD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())",
      "http_requests_total % http_requests_total + http_requests_total" ->
        "BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MOD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())",
      ...
      "((foo and bar) unless baz) or qux" ->
        "BinaryJoin(BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),LAND,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LUnless,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(baz))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LOR,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(qux))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())",
      "foo and bar unless baz or qux" ->
        "BinaryJoin(BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),LAND,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LUnless,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(baz))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LOR,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(qux))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())",

      // Pow is right associative so (bar ^ baz) should be evaluated first
      "(foo ^ (bar ^ baz))" ->
        "BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),POW,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),POW,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(baz))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())",
      "foo ^ bar ^ baz" ->
        "BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),POW,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),POW,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(baz))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())",

      "(foo + bar) or (bla and blub)" ->
        "BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LOR,ManyToMany,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bla))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),LAND,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(blub))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())",
      "foo + bar or bla and blub" ->
        "BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),LOR,ManyToMany,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bla))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),LAND,ManyToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(blub))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())",

      "bar + on(foo) (bla / on(baz, buz) group_right(test) blub)" -> """BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bla))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,OneToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(blub))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Some(List(baz, buz)),List(),List(test)),Some(List(foo)),List(),List())""",
      "bar + on(foo) bla / on(baz, buz) group_right(test) blub" -> """BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bar))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(bla))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),DIV,OneToMany,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(blub))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Some(List(baz, buz)),List(),List(test)),Some(List(foo)),List(),List())""",
      "sort(http_requests_total)" ->
        "ApplySortFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),Sort)",
      "sort_desc(http_requests_total)" ->
        "ApplySortFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),SortDesc)",
      "absent(http_requests_total{host=\"api-server\"})" -> "ApplyAbsentFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(host,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(ColumnFilter(host,Equals(api-server)), ColumnFilter(__name__,Equals(http_requests_total))),RangeParams(1524855988,1000,1524855988),List())",
      "count_values(\"freq\", http_requests_total)" ->
        "Aggregate(CountValues,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(freq),None)",
      "timestamp(http_requests_total)" -> "PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,0,Timestamp,false,List(),None,None)",
      "sum:some_metric:dataset:1m{_ws_=\"demo\", _ns_=\"test\"}" -> "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(_ws_,Equals(demo)), ColumnFilter(_ns_,Equals(test)), ColumnFilter(__name__,Equals(sum:some_metric:dataset:1m))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None)",
      ...
      "http_requests_total offset 2i" ->
        "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),Some(2000000),false),1524855988000,1000000,1524855988000,Some(2000000),None)",
      "sum(rate(foo{job=\"SNRT-App-0\"}[5i]))" -> "Aggregate(Sum,PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(SNRT-App-0)), ColumnFilter(__name__,Equals(foo))),List(),Some(5000000),None,false),1524855988000,1000000,1524855988000,5000000,Rate,true,List(),None,None),List(),None)",
      "rate(foo{job=\"SNRT-App-0\"}[5i]) + rate(bar{job=\"SNRT-App-0\"}[4i])" -> "BinaryJoin(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(SNRT-App-0)), ColumnFilter(__name__,Equals(foo))),List(),Some(5000000),None,false),1524855988000,1000000,1524855988000,5000000,Rate,true,List(),None,None),ADD,OneToOne,PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(SNRT-App-0)), ColumnFilter(__name__,Equals(bar))),List(),Some(4000000),None,false),1524855988000,1000000,1524855988000,4000000,Rate,true,List(),None,None),None,List(),List())",
      "sum(rate(foo{job=\"SNRT-App-0\"}[0.5i]))" -> "Aggregate(Sum,PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(SNRT-App-0)), ColumnFilter(__name__,Equals(foo))),List(),Some(500000),None,false),1524855988000,1000000,1524855988000,500000,Rate,true,List(),None,None),List(),None)",
      "http_requests_total - 10/2" -> """ScalarVectorBinaryOperation(SUB,ScalarBinaryOperation(DIV,Left(10.0),Left(2.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false)""",
      "foo - http_requests_total * 2^3" -> """BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),SUB,OneToOne,ScalarVectorBinaryOperation(MUL,ScalarBinaryOperation(POW,Left(2.0),Left(3.0),RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false),None,List(),List())""",
      "sum(http_requests_total) - 10/2" -> """ScalarVectorBinaryOperation(SUB,ScalarBinaryOperation(DIV,Left(10.0),Left(2.0),RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(http_requests_total))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),false)""",
      ...
      "ceil(sum(foo) / 10 / 10 / 10)" -> """ApplyInstantFunction(ScalarVectorBinaryOperation(DIV,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(DIV,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(DIV,ScalarFixedDoublePlan(10.0,RangeParams(1524855988,1000,1524855988)),Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),false),false),false),Ceil,List())""",
      "metric1 * metric2 + metric3" -> """BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MUL,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())""",
      "metric1 * (metric2 + metric3)" -> """BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MUL,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())""",

      "(metric1 + (metric2 * metric3)) + metric4" -> """BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MUL,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List()),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric4))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())""",
      "metric1 + metric2 * metric3 + metric4" -> """BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),MUL,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List()),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric4))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List())""",

      "(metric1 + metric2) * (metric3 + metric4)" -> """BinaryJoin(BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),MUL,OneToOne,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(metric4))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),None,List(),List())""",
      "count((some_metric / 300) >= 1 ) or vector(0)" -> """BinaryJoin(Aggregate(Count,ScalarVectorBinaryOperation(GTE,ScalarFixedDoublePlan(1.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(DIV,ScalarFixedDoublePlan(300.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(some_metric))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false),false),List(),None),LOR,ManyToMany,VectorPlan(ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988))),None,List(),List())""",
      "count(some_metric / 300 >= 1 ) or vector(0)" -> """BinaryJoin(Aggregate(Count,ScalarVectorBinaryOperation(GTE,ScalarFixedDoublePlan(1.0,RangeParams(1524855988,1000,1524855988)),ScalarVectorBinaryOperation(DIV,ScalarFixedDoublePlan(300.0,RangeParams(1524855988,1000,1524855988)),PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(some_metric))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),false),false),List(),None),LOR,ManyToMany,VectorPlan(ScalarFixedDoublePlan(0.0,RangeParams(1524855988,1000,1524855988))),None,List(),List())""",
      "sum((some_metric))" -> """Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(some_metric))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None)""",
      "sum((foo + foo))" -> """Aggregate(Sum,BinaryJoin(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),ADD,OneToOne,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),None,List(),List()),List(),None)""",
      "(sum(foo1) + sum(foo2))/(sum(foo3) + sum(foo4))" -> """BinaryJoin(BinaryJoin(Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo1))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),ADD,OneToOne,Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo2))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),None,List(),List()),DIV,OneToOne,BinaryJoin(Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo3))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),ADD,OneToOne,Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(__name__,Equals(foo4))),List(),Some(300000),None,false),1524855988000,1000000,1524855988000,None,None),List(),None),None,List(),List()),None,List(),List())""",
      "foo[5m:1m]" -> """TopLevelSubquery(PeriodicSeries(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,None,None),1524855720000,60000,1524855960000,300000,None,None)""",
      "deriv(rate(distance_covered_meters_total[1m])[5m:1m])[6m:3m]" -> """TopLevelSubquery(SubqueryWithWindowing(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855480000,1524855960000),List(ColumnFilter(__name__,Equals(distance_covered_meters_total))),List(),Some(60000),None,false),1524855480000,60000,1524855960000,60000,Rate,false,List(),None,None),1524855780000,180000,1524855960000,Deriv,List(),300000,60000,None,None),1524855780000,180000,1524855960000,360000,None,None)""",
      "max_over_time(rate(foo[5m])[5m:1m])" -> """SubqueryWithWindowing(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,300000,Rate,false,List(),None,None),1524855988000,0,1524855988000,MaxOverTime,List(),300000,60000,None,None)""",
      "max_over_time(sum(foo)[5m:1m])" -> """SubqueryWithWindowing(Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,None,None),List(),None),1524855988000,0,1524855988000,MaxOverTime,List(),300000,60000,None,None)""",
      "sum(foo)[5m:1m]" -> """TopLevelSubquery(Aggregate(Sum,PeriodicSeries(RawSeries(IntervalSelector(1524855720000,1524855960000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855720000,60000,1524855960000,None,None),List(),None),1524855720000,60000,1524855960000,300000,None,None)""",
      "avg_over_time(max_over_time(rate(foo[5m])[5m:1m])[10m:2m])" -> """SubqueryWithWindowing(SubqueryWithWindowing(PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855180000,1524855960000),List(ColumnFilter(__name__,Equals(foo))),List(),Some(300000),None,false),1524855180000,60000,1524855960000,300000,Rate,false,List(),None,None),1524855480000,120000,1524855960000,MaxOverTime,List(),300000,60000,None,None),1524855988000,0,1524855988000,AvgOverTime,List(),600000,120000,None,None)""",
