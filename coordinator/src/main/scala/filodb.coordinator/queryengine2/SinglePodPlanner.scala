...
class SinglePodPlanner(dsRef: DatasetRef,
  ...
  def generateLocalExecPlan(logicalPlan: LogicalPlan,
                            queryId: String,
                            submitTime: Long,
  ...
  private def shardsFromFilters(filters: Seq[ColumnFilter],
                                ...
                                spreadProvider : SpreadProvider): Seq[Int] = {
