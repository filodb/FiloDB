...
class PlannerUtilSpec  extends AnyFunSpec with Matchers {
  ...
  it ("should rewrite the plan to make RawSeries support remote calls") {
    val startSec = 0
    val endSec = 100
    val expectedRangeSelector = IntervalSelector(1000 * startSec, 1000 * endSec)
    val q1 = "foo{}[10m]"
    val lp1 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q1, TimeStepParams(start, 0, end)), startSec, endSec)
    ...
    val lp2 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q2, TimeStepParams(start, 0, end)), startSec, endSec)
    ...
    val lp3 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q3, TimeStepParams(start, 0, end)), startSec, endSec)
    ...
    val lp4 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q4, TimeStepParams(start, 0, end)), startSec, endSec)
    ...
    val lp5 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q5, TimeStepParams(start, 0, end)), startSec, endSec)
    ...
    val lp6 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q6, TimeStepParams(start, 0, end)), startSec, endSec,
      additionalLookbackSec = 600000)
    ...
    val lp7 = rewritePlanWithRemoteRawExport(
      Parser.queryRangeToLogicalPlan(q7, TimeStepParams(start, 0, end)), startSec, endSec,
      additionalLookbackSec = 600000)
